    ...
    for member in message.new_chat_members:
        if member.id == bot_id:
            ...
            return await message.reply(
                "Hlow, English Is My Current Language U can change By a Command /lang.\n"
                "Make Me Admin With Full Rights\n"
                "btw, thanks for inviting me to here, to use me, please type /start then use /userbotjoin command first.\n"
                "don't forget to subscribe our channel.",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Channel", url=config.CHANNEL),
                            InlineKeyboardButton("Developer", url="https://t.me/Timesisnotwaiting"),
                        ],
                        [
                            InlineKeyboardButton("Assistant", url=f"https://t.me/Zaid2_Assistant")
                        ]
                    ]
                )
            )
